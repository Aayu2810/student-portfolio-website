...
export default function TestLockerPage() {
  ...
  const handleUpload = (files: File[]) => {
    ...
    alert(`Upload functionality would handle ${files.length} files`);
  };

  // Listen for the openUploadModal event from the layout
  useEffect(() => {
  ...
  const handleCreateFolder = () => {
    ...
    alert("Create folder functionality would open here. In a complete implementation, this would open the folder creation dialog.");
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm flex items-center ${viewMode === "grid" 
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm flex items-center ${viewMode === "list" 
              ? "bg-purple-600 hover:bg-purple-700 text-white" 
              : "border border-white/10 hover:bg-white/10 text-white"
            }`}
          >
