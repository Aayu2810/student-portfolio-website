...
CREATE TABLE portfolios (
  ...
  -- Portfolio Settings
  theme_primary TEXT DEFAULT '#1cabf2'::text,
  theme_secondary TEXT DEFAULT '#00d9ff'::text,
  theme_background TEXT DEFAULT '#000000'::text,
  template TEXT DEFAULT 'modern'::text CHECK (template = ANY (ARRAY['minimal'::text, 'modern'::text, 'creative'::text, 'professional'::text, 'dark'::text])),
  tagline TEXT,
  about TEXT,
  skills JSONB DEFAULT '[]'::jsonb,
  sections JSONB DEFAULT '[]'::jsonb,
  featured_documents UUID[] DEFAULT '{}',
